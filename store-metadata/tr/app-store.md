# App Store — Türkçe Metadata

## İsim (30 karakter maks.)
BLOOM: AI Alışkanlık Koçu

## Alt Başlık (30 karakter maks.)
Akıllı koçun, güçlü rutinlerin

## Açıklama (4000 karakter maks.)
BLOOM, gerçek anlamda seni tanıyan bir AI alışkanlık koçu.

Alışkanlık takip uygulamalarından bıktıysan; sadece kutu işaretleyip geçiyor, hiçbir zaman neden başarısız olduğunu anlayamıyorsan — BLOOM farklı çalışır.

**🌸 AI Koç — Gerçek Konuşma**
...
**💎 Habit DNA**
Fitness, zihin, uyku, sosyal, yaratıcılık — tüm kategorilerde dengeni gösteren hexagon profil. Sosyal medyada paylaşılabilir kart.

**⚡ Hızlı Tamamlama**
Günlük alışkanlıklar tek ekranda. Tamamla, sil, ertele — saniyeler içinde.

---

**BLOOM Premium ile her şey sınırsız:**
...
alışkanlık,koç,AI,rutin,streak,motivasyon,günlük,hedef,meditasyon,fitness,zihin,produktivite

## Promosyon Metni (170 karakter)
AI koçunla alışkanlıklarını bir üst seviyeye taşı. Haftalık kişisel rapor, sınırsız streak takibi ve gerçek konuşma — hepsi BLOOM'da.

## Destek URL
https://bloom-habit.app/destek

## Gizlilik Politikası URL
https://bloom-habit.app/gizlilik
